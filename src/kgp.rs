...
pub(crate) const MAX_BANDS: usize = DIACRITICS.len();
...
mod tests {
    ...
    fn the_first_cell_names_its_band_and_the_rest_run_on() {
        ...
        assert_eq!(chars[1], DIACRITICS[2], "row 2");
        assert_eq!(chars[2], DIACRITICS[0], "column 0");
        ...
        assert!(placeholder(DIACRITICS.len(), 9).is_none());
    }
